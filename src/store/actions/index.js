...
export const setUserSpotifyDataStarted = () => ({ type: types.SET_USER_SPOTIFY_DATA, status: "error" });
export const setUserSpotifyDataError = payload => ({ type: types.SET_USER_SPOTIFY_DATA, status: "error",  payload });
export const setUserSpotifyDataFinished = payload => ({ type: types.SET_USER_SPOTIFY_DATA, status: "error",  payload });
